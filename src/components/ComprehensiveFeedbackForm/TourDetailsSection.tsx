  ...
  return (
    <div className="tour-details grid grid-cols-7 gap-2 border border-black p-4 mb-6">
      <div className="text-center border-r border-black pr-2">
        <div className="font-bold">{selectedTour.truck_name || 'Truck Name'}</div>
        <div className="text-sm text-gray-600">TRUCK</div>
      </div>
      
      <div className="text-center border-r border-black px-2">
        <div className="font-bold">{selectedTour.driver_name}</div>
        <div className="text-sm text-gray-600">DRIVER</div>
      </div>
      
      <div className="text-center border-r border-black px-2">
        <div className="font-bold">{selectedTour.guide_name}</div>
      ...
      <div className="text-center border-r border-black px-2">
        <div className="font-bold">{selectedTour.tour_leader || selectedTour.tour_id}</div>
        <div className="text-sm text-gray-600">CODE</div>
      </div>
      
      <div className="text-center pl-2">
        <div className="font-bold">{selectedTour.tour_leader || selectedTour.guide_name}</div>
